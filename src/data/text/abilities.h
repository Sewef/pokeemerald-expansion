...
static const u8 sTangledFeetDescription[] = _("Augment Esquive si confu.");
static const u8 sMotorDriveDescription[] = _("Elec augmente Vitesse.");
...
static const u8 sPoisonHealDescription[] = _("Restaure PV si poison.");

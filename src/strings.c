...
const u8 gText_XNatureMetAtYZ[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05} de nature,\nrencontré au {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01},\n{DYNAMIC 0x00}{DYNAMIC 0x04}{DYNAMIC 0x01}.");
const u8 gText_XNatureHatchedAtYZ[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05} nature,\nde nature,\na éclos au {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01},\n{DYNAMIC 0x00}{DYNAMIC 0x04}{DYNAMIC 0x01}.");
const u8 gText_XNatureObtainedInTrade[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05} de nature,\nobtenu dans un échange.");
const u8 gText_XNatureFatefulEncounter[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05} de nature,\nobtenu lors d'un évènement\nspécial au {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01}.");
const u8 gText_XNatureProbablyMetAt[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05} de nature,\nprobablement rencontré au\n {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01},\n{DYNAMIC 0x00}{DYNAMIC 0x04}{DYNAMIC 0x01}.");
const u8 gText_XNature[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05} de nature.");
const u8 gText_XNatureMetSomewhereAt[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05} de nature,\nrencontré quelque part\nau {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01}.");
const u8 gText_XNatureHatchedSomewhereAt[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05} de nature,\na éclos quelque part\nau {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01}.");
...
const u8 gText_EnergyPowder50[] = _("POUDRENERGIE{CLEAR_TO 0x72}{FONT_SMALL 0}50");
const u8 gText_EnergyRoot80[] = _("RACINENERGIE{CLEAR_TO 0x72}{FONT_SMALL 0}80");
const u8 gText_HealPowder50[] = _("POUDRE SOIN{CLEAR_TO 0x72}{FONT_SMALL 0}50");
...
const u8 gText_PkmnWasReleased[] = _("{DYNAMIC 0x00} a été relâché.");
...
const u8 gText_ChangedToNewItem[] = _("Changé pour {DYNAMIC 0x00} !");
...
const u8 gText_PokemonMaleLv[] = _("{DYNAMIC 0x00}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 0x01}"); // Unused
const u8 gText_PokemonFemaleLv[] = _("{DYNAMIC 0x00}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 0x01}"); // Unused
...
const u8 gText_NumberIndex[] = _("Nº {DYNAMIC 0x00}");
const u8 gText_RibbonsF700[] = _("RUBANS: {DYNAMIC 0x00}");
const u8 gText_PokemonMaleLv2[] = _("{DYNAMIC 0x00}{COLOR_HIGHLIGHT_SHADOW LIGHT_RED WHITE GREEN}♂{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 0x01}{DYNAMIC 0x02}"); // Unused
const u8 gText_PokemonFemaleLv2[] = _("{DYNAMIC 0x00}{COLOR_HIGHLIGHT_SHADOW LIGHT_GREEN WHITE BLUE}♀{COLOR_HIGHLIGHT_SHADOW DARK_GRAY WHITE LIGHT_GRAY}/{LV}{DYNAMIC 0x01}{DYNAMIC 0x02}"); // Unused
const u8 gText_PokemonNoGenderLv2[] = _("{DYNAMIC 0x00}/{LV}{DYNAMIC 0x01}{DYNAMIC 0x02}"); // Unused
...
const u8 gText_F700sQuiz[] = _("Quiz de {DYNAMIC 0x00}");
...
const u8 gJPText_PlayersXPokemon[] = _("{DYNAMIC 0x00}の{DYNAMIC 0x01}ひきめ:"); // Unused
const u8 gJPText_PlayersXPokmonDoesNotExist[] = _("{DYNAMIC 0x00}の{DYNAMIC 0x01}ひきめは いません"); // Unused
const u8 gText_ExitingChat[] = _("Départ du tchat…");
const u8 gText_LeaderLeftEndingChat[] = _("Le MENEUR, {DYNAMIC 0x00}, part\net met fin au tchat.");
...
const u8 gText_PlayerSavedGame_Chat[] = _("{DYNAMIC 0x00} a sauvegardé la partie.");
...
ALIGNED(4) const u8 gText_1DotBlueF700[] = _("1. {COLOR BLUE}{SHADOW LIGHT_BLUE}{DYNAMIC 0x00}");
ALIGNED(4) const u8 gText_1DotF700[] = _("1. {DYNAMIC 0x00}");
...
const u8 gText_PokedexDiploma[] = _("Joueur: {CLEAR 0x10}{COLOR RED}{SHADOW LIGHT_RED}{PLAYER}À{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}\n\nPOKéDEX {STR_VAR_1}\nCe document certifie\nque vous avez complété\nvotre POKéDEX.\n\n{CLEAR_TO 0x42}{COLOR RED}{SHADOW LIGHT_RED}GAME FREAK");
...
const u8 gText_F700Players[] = _("{DYNAMIC 0x00} JOUEURS");
